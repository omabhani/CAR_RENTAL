...
if (isset($_POST['login'])) {
    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($password, $seller['password'])) {
            ...
            echo "<script>alert('Login successful!'); window.location.href='seller_dashboard.php';</script>";
        } else {
            echo "<script>alert('Invalid password');</script>";
        }
    } else {
        echo "<script>alert('No seller found with that email');</script>";
    }
}
?>
<!DOCTYPE html>
...
<nav class="navbar">
  ...
  <div class="form-container">
    ...
    <form method="post" action="">
      ...
      <p>Don't have an account? <a href="seller_register.php">Register</a></p>
    </form>
  </div>
</body>
</html>