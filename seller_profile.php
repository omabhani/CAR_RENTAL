...
if (isset($_POST['update_profile'])) {
    ...
    $update_query = "UPDATE sellers SET name='$name', email='$email', phone='$phone' WHERE id=$id";
...
if (isset($_POST['change_password'])) {
    ...
    $pass_query = mysqli_query($conn, "SELECT password FROM sellers WHERE id=$id");
...
$result = mysqli_query($conn, "SELECT * FROM sellers WHERE id=$id"); 
    ...
    <div class="container">
        <div class="profile-header">
            <div class="profile-avatar">
                <?php echo substr($seller['name'], 0, 1); ?>
            </div>
            <div class="profile-name"><?php echo $seller['name']; ?></div>
            <div class="profile-email"><?php echo $seller['email']; ?></div>
        </div>
            ...
            <div class="profile-section">
                ...
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" value="<?php echo $seller['phone']; ?>" required>
                    </div>
